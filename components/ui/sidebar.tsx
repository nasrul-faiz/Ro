  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "flex h-full w-(--sidebar-width) flex-col bg-sidebar/40 text-sidebar-foreground backdrop-blur-2xl backdrop-saturate-150 supports-backdrop-filter:bg-sidebar/30",
          className
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) bg-sidebar/50 p-0 text-sidebar-foreground backdrop-blur-2xl backdrop-saturate-150 supports-backdrop-filter:bg-sidebar/40 [&>button]:hidden"
          style={
            {
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar/40 backdrop-blur-2xl backdrop-saturate-150 supports-backdrop-filter:bg-sidebar/30 group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-lg group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border/50"
        >
          {children}
        </div>
      </div>
